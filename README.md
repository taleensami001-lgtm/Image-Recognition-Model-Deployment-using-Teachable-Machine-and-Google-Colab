...
1. إعداد الفئات ورفع البيانات التدريبية (Setting up Classes and Uploading Training Data)
بالعربية:
...
3. اختبار وتقييم النموذج (Testing and Evaluating the Model)
بالعربية:
...
4. تصدير النموذج (Exporting the Model)
بالعربية:
...
5. تطبيق النموذج في بيئة Google Colab (Deploying the Model in Google Colab)
بالعربية:
